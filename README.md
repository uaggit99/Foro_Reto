...
<font color="green"> El proyecto tiene el CRUD  para el usuario , en el registro de un usuario  envia un correo al Email ingresado
con el loggin y la clave llamado al EmailService </font>
